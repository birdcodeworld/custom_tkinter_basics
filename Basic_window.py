...
class App(customtkinter.CTk):
	...
	def __init__(self):
		...
		self.casual_checkbox = customtkinter.CTkCheckBox(self.checkbox_frame, text = 'Casual Birdwatcher', variable = self.casual_value)
		self.casual_checkbox.grid(row = 0, column = 0, padx = 20, pady = (30, 20), sticky = 'w')
		self.backyard_checkbox = customtkinter.CTkCheckBox(self.checkbox_frame, text = 'Backyard Birder', variable = self.backyard_value)
		self.backyard_checkbox.grid(row = 0, column = 1, padx = 20, pady = (30,20), sticky = 'w')
		self.twitcher_chechbox = customtkinter.CTkCheckBox(self.checkbox_frame, text = 'Twitcher (or Chaser)', variable = self.twitcher_value)
		self.twitcher_chechbox.grid(row = 1, column = 0, padx = 20, pady = (30, 20), sticky = 'w')
		self.lister_checkbox = customtkinter.CTkCheckBox(self.checkbox_frame, text = 'Lister (or Ticker)', variable = self.lister_value)
		self.lister_checkbox.grid(row = 1, column = 1, padx = 20, pady = (30, 20), sticky = 'w')
		self.photographic_checkbox = customtkinter.CTkCheckBox(self.checkbox_frame, text = 'Photographic Birder', variable = self.photo_value)
		self.photographic_checkbox.grid(row = 2, column = 0, padx = 20, pady = (30, 20), sticky = 'w')
		self.scientific_checkbox = customtkinter.CTkCheckBox(self.checkbox_frame, text = 'Scientific Birder', variable = self.sci_value)
		self.scientific_checkbox.grid(row = 2, column = 1, padx = 20, pady = (30, 20), sticky = 'w')
		self.travel_checkbox = customtkinter.CTkCheckBox(self.checkbox_frame, text = 'Travel & Eco-Tour Birder', variable = self.travel_value)
		self.travel_checkbox.grid(row = 3, column = 0, padx = 20, pady = (30, 20), sticky = 'w')
		self.sound_checkbox = customtkinter.CTkCheckBox(self.checkbox_frame, text = 'Sound Birder (By-Ear Birder)', variable = self.sound_value)
		self.sound_checkbox.grid(row = 3, column = 1, padx = 20, pady = (30, 20), sticky = 'w')
		self.armchair_checkbox = customtkinter.CTkCheckBox(self.checkbox_frame, text = 'Armchair Birder', variable = self.armchair_value)
		self.armchair_checkbox.grid(row = 4, column = 0, padx = 20, pady = (30, 20), sticky = 'w')
		self.artistic_checkbox = customtkinter.CTkCheckBox(self.checkbox_frame, text = 'Artistic Birder', variable = self.artistic_value)
		self.artistic_checkbox.grid(row = 4, column = 1, padx = 20, pady = (30, 20), sticky = 'w')
		self.conservation_checkbox = customtkinter.CTkCheckBox(self.checkbox_frame, text = 'Conservation-Focused Birder', variable = self.conservation_value)
		self.conservation_checkbox.grid(row = 5, column = 0, padx = 20, pady = (30, 20), sticky = 'w')
		self.social_checkbox = customtkinter.CTkCheckBox(self.checkbox_frame, text = 'Social Birder', variable = self.social_value)
